...
\section[\texorpdfstring{$\varepsilon$}{epsilon}-optimal strategi]{$\bm{\varepsilon}$-optimal strategi}\label{Snyd}

Dette er baseret på \cite[s. 88]{"Markov_decision_process"}.

\begin{minipage}\textwidth
\begin{thmx} \textbf{$\bm \varepsilon$-optimal strategi} \label{sæt:epsopt}%Ny sætning
\newline
