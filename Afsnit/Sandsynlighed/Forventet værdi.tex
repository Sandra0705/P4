...
\begin{minipage}\textwidth
\begin{defn}\textbf{Betingede forventet værdi}\label{def:betinget_forventet_værdi} %Ny definition
\newline
...
I ovenstående definition er den forventede værdi af den diskrete tilfældige variabel, $X$, betinget af en hændelse, $B$. For hændelser på formen $B_j = \{Y=y_j\}$ defineres betinget forventet værdi som følgende 

\begin{minipage}\textwidth
\begin{defn}\textbf{Betingede forventet værdi af diskrete tilfældige variabler}\label{def:betinget_forventet_værdi_af_diskrete_tilfældige_variabler} %Ny definition
\newline
