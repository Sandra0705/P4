...
\end{align*}
hvis den forventede værdi eksisterer. Er strategien derimod fortidsafhængig deterministisk, $\Psi\in\Pi^{FD}$, er $Y_t = d_t(h_t)$ til hvert beslutningstidspunkt. %Under antagelsen om, at $|r_t(s,a)| < \infty$ for $(s,a) \in S \times A$, samt $t \leq N$, kan $v_N^\Psi$ eksistere. 
