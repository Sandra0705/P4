...
\begin{minipage}\textwidth
\begin{defn}\textbf{Tilbagevendende og forbigående} \label{def:tau}%Ny definition
\newline
...
Altså gælder det, at hvis $i$ er positiv tilbagevendende, forventes det, at der er et endeligt antal trin, før Markov-kæden vender tilbage til $i$. For en tilstand der er null tilbagevendende, forventes der derimod at gå uendeligt mange trin, før kæden vender tilbage til tilstanden. 

%For en Markov-kæde med et endeligt tilstandsrum vil det ikke være muligt for tilstande at være null tilbagevendende. 
...
Bemærk desuden, at indgangene i $\bm\ \pi$ opfylder,
...
\begin{minipage}\textwidth
\begin{thmx} \label{sæt:den_vi_ikke_beviser}\textbf{} %Ny sætning
\newline
...
\begin{minipage}\textwidth
\begin{thmx} \textbf{Konvergens for en Markov-kæde}\label{sæt:konvergens_for_markov} %Ny sætning
\newline
...
% \begin{minipage}\textwidth
% \begin{pro} \label{prop:ured_endelig_inva}\textbf{} %Ny proposition
% \newline
