\section{Optimering af belønning}
...
Lad $\Psi\in \Pi^{FT}$ og lad tilstandsrummet, $S$, være diskret. Så er det muligt at bestemme $u_t^\Psi$ med følgende evalueringsalgoritme for en endelig strategi. %\textit{endelige strategi evalueringsalgoritme}, som er givet ved følgende
